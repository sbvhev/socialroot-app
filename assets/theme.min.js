...
!(function(e) {
				...
				return (
					_createClass(e, [
						...
						},
						{
							key: "getSelectedCell",
							value: function() {
								return this.flickityInstance.selectedCell
									.element;
							}
						},
						{
					...
					},
					{
						...
						value: function(e) {
							if ("auto" !== e.style.height) {
								e.style.height =
									e.firstElementChild.scrollHeight + "px";
								var t = function n(t) {
							...
							},
							{
								...
								value: function() {
									(this._openListener = this.open.bind(this)),
										(this._closeListener = this.close.bind(
											this
										)),
				...
				function e(t, n) {
					_classCallCheck(this, e),
						...
						(this.preferredPosition =
							n.preferredPosition || "bottom"),
						(this.isOpen = !1),
						(this.onValueChanged =
							n.onValueChanged || function() {}),
						(this.onOpen = n.onOpen || function() {}),
						(this.onClose = n.onClose || function() {}),
						(this.showOverlay =
							void 0 === n.showOverlay || n.showOverlay),
						(this.pageOverlayElement = document.querySelector(
							".PageOverlay"
						)),
						this._attachListeners();
						...
						},
						{
							...
							value: function() {
								(this._handleKeyboardListener = this._handleKeyboard.bind(
									...
									(this._toggleListener = this.toggle.bind(
										this
									)),
									this.element.addEventListener(
										"keyup",
				...
				_createClass(e, [
					...
					},
					{
						...
						value: function() {
							...
							var i = this.provinceSelect.getAttribute(
								"data-default"
							);
								...
								this.slideshow.flickityInstance.cells.forEach(
									function(t) {
										t.element.classList.contains(
											...
											e.push(
												t.element.querySelector("img")
											);
									}
								),
									this._createPhotoSwipeInstance(
										this._createPhotoSwipeItemsFromImages(
											e
										),
										parseInt(
						...
						},
						{
							...
							value: function(e) {
								return e.map(function(e) {
									var t = parseInt(
											e.getAttribute("data-max-width")
										),
										n = parseInt(
											e.getAttribute("data-max-height")
										),
										i = o["default"].matchesBreakpoint(
											"phone"
										)
											? 1200
											: 1800,
						...
						value: function(t) {
							function n(e, t) {
								...
								var o = e.substr(0, i),
									s = {};
								return (
									(s[e.substring(i + 1, e.length - 1)] = t),
									n(o, s)
								);
							}
							for (
								var i = {}, a = 0, o = t.elements.length;
								a < o;
								a++
							) {
								var s = t.elements[a];
					...
					_createClass(e, [
						{
							key: "_attachListeners",
							value: function() {
								(this._closeListener = this._closeModal.bind(
									this
								)),
									(this._handleKeyboardListener = this._handleKeyboard.bind(
										this
			...
			r = (function() {
				function e(t) {
					_classCallCheck(this, e),
						...
						this.options.drawer &&
							(this.sidebarDrawer = new i["default"](
								this.element,
					...
					_createClass(e, [
						...
						},
						{
							...
							value: function(e) {
								...
								var i = this.element.querySelector(".Cart")
									.parentNode;
						...
						},
						{
							...
							value: function(e, t) {
								var n = this,
									...
									o = this.collectionInnerElement.querySelector(
										".ProductList"
									);
								if (o) {
									var r = parseInt(
										o.getAttribute("data-" + i + "-count")
									);
									if (r === a) return;
										...
										s["default"]
											...
											.forEach(function(e) {
												...
												window.theme
													...
													(e.firstElementChild.style.visibility =
														"hidden");
											}),
						...
						},
						{
							...
							value: function(e) {
								...
								this._updateActiveTags(),
									r["default"].matchesBreakpoint(
										"lap-and-up"
									) &&
										"sidebar" ===
											this.settings.filterPosition &&
										this._commit();
							}
						},
						{
									...
									this.timeline.eventCallback(
										...
										function() {
											i.setAttribute(
												...
												s.ResponsiveHelper.matchesBreakpoint(
													"lap-and-up"
												) &&
													n.carousels.forEach(
														function(e) {
				...
				function e(t) {
					_classCallCheck(this, e),
						...
						this.options.usePlaceholder ||
							...
							(this.productVariants = new i["default"](
								t,
								this.options
							));
								...
								fastdom.measure(function() {
									document.documentElement.style.setProperty(
										...
										document.documentElement.style.setProperty(
											...
											n.options.hasTransparentHeader
												? 0
												: 1
										);
								});
								...
								(this._checkTransparentHeaderListener = this._checkTransparentHeader.bind(
									...
									("inline" !==
										...
										window.addEventListener(
											"resize",
											this
												._verifyNavigationOverlapListener
										);
							}
						},
						{
	...
	function(e, t, n) {
		...
		var i = (function() {
			...
			return (
				_createClass(e, [{ key: "onUnload", value: function() {} }]), e
			);
		})();
		t["default"] = i;
	},
		...
		var i = n(1),
			a = (function() {
				function e(t) {
					_classCallCheck(this, e),
						(this.element = t),
						(this.instafeed = this.element.querySelector(
							".Instafeed"
						)),
						this._initFeed();
				}
			...
			d = (function() {
				function e(t) {
					_classCallCheck(this, e),
						...
						"coming-soon" !== this.options.templateSuffix &&
							(this.productVariants = new a["default"](
								t,
								this.options
							)),
				...
				return (
					_createClass(e, [
						...
						},
						{
							...
							value: function(e) {
								...
								if (
									...
									if (
										u.ResponsiveHelper.matchesBreakpoint(
											"pocket"
										) ||
										!this.options.stackProductImages
									)
										for (
											...
											i !==
											this.productSlideshow
												.flickityInstance.cells.length;
											++i
										) {
											var a = this.productSlideshow
													.flickityInstance.cells[i]
													.element,
												o = parseInt(
													a.getAttribute(
														"data-image-id"
						...
						},
						{
							...
							value: function(e) {
								this.options.stackProductImages &&
									(this.slideshowNavDotsItems.forEach(
										function(e) {
											return e.classList.remove(
												"is-selected"
											);
						...
						},
						{
							...
							value: function(e, t) {
								for (
									...
									var i = this.productSlideshow
											.flickityInstance.cells[n].element,
										a = parseInt(
								...
								if (n !== i)
									if ("phone" === n || "tablet" === n)
										...
										if (
											...
											this.options.stackProductImages &&
												...
												this.options.showThumbnails &&
													...
													(a = 250),
												(this.carouselNavScrollSpy = new r[
													"default"
												](
													this.element,
													this.slideshowImages,
										...
										d(),
											...
											(this.productInfoScroller = new c[
												"default"
											](this.productInfoElement)),
											this.options.showThumbnails &&
												this.slideshowNavThumbnails &&
												(this.productThumbnailsScroller = new c[
													"default"
												](this.slideshowNavThumbnails));
									}
							}
			...
			r = (function() {
				function e(t) {
					_classCallCheck(this, e),
						...
						(this.usePocketMode = s["default"].matchesBreakpoint(
							"pocket"
						)),
						...
						},
						{
							...
							value: function() {
								...
								o["default"]
									...
									.forEach(function(t) {
										var n = parseInt(
											t.getAttribute("data-look-index")
										);
						...
						},
						{
							...
							value: function() {
								...
								if (
									...
									var n = this.slideshow.flickityInstance
											.cells[e + 1].element,
		...
		!(function() {
			...
			e.register("header", o.HeaderSection),
				...
				e.register(
					...
					o.ProductRecommendationsSection
				),
